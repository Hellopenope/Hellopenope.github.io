...
function MemoryGame(Model,len) { //<-- CHANGED
  var matchCards = Model.match,
      displayCard = Model.display,
      faceupCard = false, // lifted card, if any
  ...
  this.lift = function(where) { // this will need to call on the collection
    ...
    var modelWhere = collection.at(where),
        modelFaceup = collection.at(faceupCard);
...
var gui = null,
    game = null;  //global for debugging

$(function() {
  game = new MemoryGame(TestCardModel,20); //<-- CHANGED
